...
<html lang="ko">
    ...
    <body class="sb-nav-fixed">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form>
						  <div class="mb-3 mt-3">
						    <label for="bno" class="form-label"><i class="fas fa-check"></i> bno</label>
						    <input type="text" class="form-control" id="bno" name="bno" value="${board.bno}" disabled>
						  </div>
						  <div class="mb-3">
						    <label for="title" class="form-label"><i class="fas fa-pen-nib"></i> title</label>
						    <input type="text" class="form-control" id="title" name="title" value="${board.title}" disabled>
						  </div>
						  <div class="mb-3">
						    <label for="content" class="form-label"><i class="fas fa-file"></i> content</label>
		  ...
		  <div class="modal-dialog">
		    <div class="modal-content">		
		      ...
		      <div class="modal-body">
		        <div class="mb-3 mt-3">
				    <label for="rno" class="form-label"><i class="fas fa-check"></i> rno</label>
				    <input type="text" class="form-control" id="rno" name="rno">
				  </div>
				  <div class="mb-3">
				    <label for="replyContent" class="form-label"><i class="fas fa-file"></i> content</label>
		...
		<script>
			...
			// replyService.add({bno : 188, content : 'get.jsp', writer : 'javaman'}, function(data) {
			// 	console.log(data);
			// }, cp);
