                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            <div class="form-floating input-group mb-3">
                                                <input class="form-control" id="id" type="text" name="id" placeholder="enter ID"/>
                                            ...
                                            <div class="form-floating mb-3 input-group">
                                                ...
                                                <button class="btn btn-success" type="button" id="btnEmail">Email 중복체크</button>
